...
export declare const defaultSpellbookState: SpellbookState;
export type SpellbookFieldErrors = Partial<Record<"castid" | "effectid" | "cost" | "cast" | "title" | "description", string>>;
